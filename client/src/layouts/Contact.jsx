            ...
            >
              <Paper elevation={3}>
                ...
                // className={classes.paper}
                  ...
                  secondary={<Typography type="body2" style={{ color: theme.palette.primary.light }}>(352) 376-6008</Typography>}
                />
                <ListItemText
                // className={classes.paper}
                  align="center"
                  ...
                  secondary={<Typography type="body2" style={{ color: theme.palette.primary.light }}>attractions.salon@gmail.com</Typography>}
                />
                <ListItemText
                // className={classes.paper}
                  align="center"
                  primary={(
                    <Typography type="body2" style={{ color: 'black' }}>
                      ...
                      <Link href="https://www.facebook.com/pages/Attractions-Salon/746300208837896">
                        facebook
                      </Link>
                    </Typography>
)}
                  secondary={<Typography type="body2" style={{ color: theme.palette.primary.light }} />}
                />
              </Paper>
            </Grid>
            {/* <Review /> */}
